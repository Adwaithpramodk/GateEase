...
urlpatterns = [
   ...
   path('DeleteMentor/<int:id>',DeleteMentor.as_view(),name='delete_mentor'),
   ...
   path('DeleteAssignDept/<int:id>',DeleteAssignDept.as_view(),name='DeleteAssignDept'),
    ...
    path('SendReply/<int:id>',SendReply.as_view(),name='send_reply'),
    path('ManageAnnouncements', ManageAnnouncements.as_view(), name='manage_announcements'),
    path('AddAnnouncement', AddAnnouncement.as_view(), name='add_announcement'),
    path('DeleteAnnouncement/<int:id>', DeleteAnnouncement.as_view(), name='delete_announcement'),
    ...
    path('DeleteSecurity/<int:id>',DeleteSecurity.as_view(),name='delete_security'),
    ...
    path('MentorGroupPassCreate',MentorGroupPassCreate.as_view(),name='MentorGroupPassCreate'),
    ...
    path('StudentAnnouncements', StudentAnnouncements.as_view(), name='StudentAnnouncements'),
    ...
    path('WebCheckPassStatus/<str:token>', WebCheckPassStatus.as_view(), name='WebCheckPassStatus'),

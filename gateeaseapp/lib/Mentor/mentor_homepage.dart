  ...
  Widget _actionGrid() {
    final actions = [
      ...
      },
      {
        ...
        'gradient': [AppTheme.accent, AppTheme.primary],
        'onTap': () => Navigator.push(
          context,
      ...
      },
      {
        ...
        'gradient': [const Color(0xFF0D9488), AppTheme.primaryDark],
        'onTap': () => Navigator.push(
          context,
      ...
      },
      {
        ...
        'gradient': [const Color(0xFF4F46E5), AppTheme.primaryDark],
        'onTap': () => Navigator.push(
          context,
        ...
        return GestureDetector(
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: (a['gradient'] as List<Color>)[0].withValues(
                    alpha: 0.3,
                  ),
                  blurRadius: 14,
    ...
    return Container(
      ...
      child: Column(
        children: [
          InkWell(
            onTap: () =>
                setState(() => expandedStatus = isExpanded ? null : status),
            borderRadius: BorderRadius.circular(20),
            child: Padding(
